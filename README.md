...
2. التفاصيل بتنبعث **أوتوماتيكيًا عالميل `nexora131415@gmail.com`** عن طريق [Web3Forms](https://web3forms.com) (حساب nexora131415@gmail.com). المفتاح موجود بـ`CFG.web3formsKey` بآخر `index.html`. إذا المفتاح فاضي، الموقع بيرجع لـFormSubmit كاحتياط.
